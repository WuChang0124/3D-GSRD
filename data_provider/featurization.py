...
chirality = {ChiralType.CHI_TETRAHEDRAL_CW: -1.,
             ...
             ChiralType.CHI_TRIGONALBIPYRAMIDAL:2,
             ChiralType.CHI_SQUAREPLANAR:3,
             ChiralType.CHI_TETRAHEDRAL:4,
             ChiralType.CHI_ALLENE:5,
             ChiralType.CHI_OCTAHEDRAL:6,
             }
...
merge_types = {'H': 0, 'He': 1, 'Be': 2, 'B': 3, 'C': 4, 'N': 5, 'O': 6, 'F': 7, 'Mg': 8, 'Si': 9, 
               'P': 10, 'S': 11, 'Cl': 12, 'Ar': 13, 'Ca': 14, 'Ti': 15, 'Zn': 16, 'Ga': 17, 'Ge': 18, 
               'As': 19, 'Se': 20, 'Br': 21}
...
def featurize_mol(mol, types=drugs_types):
    ...
    for i, atom in enumerate(mol.GetAtoms()):
        ...
        atom_features.extend([1 if atom.GetIsAromatic() else 0])
...
def featurize_mol_from_smiles_v2(smiles, dataset='drugs'):
